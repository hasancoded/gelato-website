      ...
      <div className="gpv1-features-inner">
        ...
        >
          ...
          <div className="gpv1-product-image">
            <Image
              src="/images/GALAXY-PRO-V2C/pic1.png"
              alt="Galaxy Pro V2C gelato machine"
              width={560}
              height={470}
...
function GpV2CSpecs() {
  const specs = [
    ...
    { label: "Production capacity per hour", value: "250 Cups / 80g" },
  ];
    ...
    >
      <div className="gpv1-specs-inner">
        <motion.div className="gpv1-specs-image" variants={scaleIn}>
          <Image
            src="/images/GALAXY-PRO-V2C/pic3.png"
            alt="Galaxy Pro V2C dimensional drawing — 720mm x 610mm x 2400mm"
            width={560}
            height={470}
            style={{ objectFit: "contain", width: "100%", height: "auto" }}
          />
    ...
    <section className="gpv1-cta">
      ...
      >
        <motion.h2 className="gpv1-cta-title" variants={fadeUp}>
          Interested in the Galaxy Pro V2C?
        </motion.h2>
...
/* ─── Page ─── */
export default function GalaxyProV2CPage() {
  return (
    <>
      <Navbar />
      <GpV2CTitle />

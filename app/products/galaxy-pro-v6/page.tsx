      ...
      <div className="gpv1-features-inner">
        ...
        >
          ...
          <div className="gpv1-product-image">
            <Image
              src="/images/GALAXY-PRO-V6/pic1.png"
              alt="Galaxy Pro V6 gelato machine"
              width={560}
              height={470}
...
function GpV6Specs() {
  const specs = [
    ...
    { label: "Production capacity per hour", value: "750 Cups / 80g" },
  ];
    ...
    >
      <div className="gpv1-specs-inner">
        <motion.div className="gpv1-specs-image" variants={scaleIn}>
          <Image
            src="/images/GALAXY-PRO-V6/pic3.png"
            alt="Galaxy Pro V6 dimensional drawing — 1500mm x 800mm x 910mm"
            width={560}
            height={470}
            style={{ objectFit: "contain", width: "100%", height: "auto" }}
          />
    ...
    <section className="gpv1-cta">
      ...
      >
        <motion.h2 className="gpv1-cta-title" variants={fadeUp}>
          Interested in the Galaxy Pro V6?
        </motion.h2>
...
/* ─── Page ─── */
export default function GalaxyProV6Page() {
  return (
    <>
      <Navbar />
      <GpV6Title />

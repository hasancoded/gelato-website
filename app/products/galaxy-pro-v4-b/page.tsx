      ...
      <div className="gpv1-features-inner">
        ...
        >
          ...
          <div className="gpv1-product-image">
            <Image
              src="/images/GALAXY-PRO-V4-B/pic1.png"
              alt="Galaxy Pro V4-B gelato machine"
              width={560}
              height={470}
...
function GpV4BSpecs() {
  const specs = [
    { label: "Dimensions", value: "1370mm \u00d7 600mm \u00d7 910mm" },
    ...
    >
      <div className="gpv1-specs-inner">
        <motion.div className="gpv1-specs-image" variants={scaleIn}>
          <Image
            src="/images/GALAXY-PRO-V4-B/pic3.png"
            alt="Galaxy Pro V4-B dimensional drawing — 1370mm x 600mm x 910mm"
            width={560}
            height={470}
            style={{ objectFit: "contain", width: "100%", height: "auto" }}
          />
    ...
    <section className="gpv1-cta">
      ...
      >
        <motion.h2 className="gpv1-cta-title" variants={fadeUp}>
          Interested in the Galaxy Pro V4-B?
        </motion.h2>
...
/* ─── Page ─── */
export default function GalaxyProV4BPage() {
  return (
    <>
      <Navbar />
      <GpV4BTitle />

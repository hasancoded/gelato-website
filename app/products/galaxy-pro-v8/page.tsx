      ...
      <div className="gpv1-features-inner">
        ...
        >
          ...
          <div className="gpv1-product-image">
            <Image
              src="/images/GALAXY-PRO-V8/pic1.png"
              alt="Galaxy Pro V8 gelato machine"
              width={560}
              height={470}
...
function GpV8Specs() {
  const specs = [
    { label: "Dimensions", value: "2000mm \u00d7 800mm \u00d7 910mm" },
    { label: "Weight", value: "460 KG" },
    { label: "Power supply", value: "32A Three phase 380V 50/60HZ" },
    { label: "Peak power", value: "7600W" },
    ...
    { label: "Production capacity per hour", value: "1000 Cups / 80g" },
  ];
    ...
    >
      <div className="gpv1-specs-inner">
        <motion.div className="gpv1-specs-image" variants={scaleIn}>
          <Image
            src="/images/GALAXY-PRO-V8/pic3.png"
            alt="Galaxy Pro V8 dimensional drawing — 2000mm x 800mm x 910mm"
            width={560}
            height={470}
            style={{ objectFit: "contain", width: "100%", height: "auto" }}
          />
    ...
    <section className="gpv1-cta">
      ...
      >
        <motion.h2 className="gpv1-cta-title" variants={fadeUp}>
          Interested in the Galaxy Pro V8?
        </motion.h2>
...
/* ─── Page ─── */
export default function GalaxyProV8Page() {
  return (
    <>
      <Navbar />
      <GpV8Title />

...
function GpV2Features() {
  ...
  const optionalItems = [
    ...
    { text: "Accessory kit for cart", patent: false },
      ...
      <div className="gpv1-features-inner">
        ...
        >
          ...
          <div className="gpv1-product-image">
            <Image
              src="/images/GALAXY-PRO-V2/pic1.png"
              alt="Galaxy Pro V2 gelato machine"
              width={560}
              height={470}
...
function GpV2Specs() {
  const specs = [
    { label: "Dimensions", value: "720mm \u00d7 610mm \u00d7 885mm" },
    ...
    >
      <div className="gpv1-specs-inner">
        <motion.div className="gpv1-specs-image" variants={scaleIn}>
          <Image
            src="/images/GALAXY-PRO-V2/pic3.png"
            alt="Galaxy Pro V2 dimensional drawing — 720mm x 610mm x 885mm"
            width={560}
            height={470}
            style={{ objectFit: "contain", width: "100%", height: "auto" }}
          />
    ...
    <section className="gpv1-cta">
      ...
      >
        <motion.h2 className="gpv1-cta-title" variants={fadeUp}>
          Interested in the Galaxy Pro V2?
        </motion.h2>
...
/* ─── Page ─── */
export default function GalaxyProV2Page() {
  return (
    <>
      <Navbar />
      <GpV2Title />

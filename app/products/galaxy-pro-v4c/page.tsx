...
function GpV4CFeatures() {
  const standardItems = [
    ...
    { text: "Quick assemble canopy structure (height adjustable)", patent: false },
    { text: "Customizable exterior graphic", patent: false },
    { text: "Cart push handle", patent: false },
  ];

  const optionalItems = [
    { text: "Built-in universal spatular holder", patent: true },
    { text: "27-inch advertising digital display", patent: false },
    { text: "Built-in Refrigerator", patent: false },
    { text: "Foldable extensive operating console", patent: false },
    { text: "Decorative wheel", patent: false },
      ...
      <div className="gpv1-features-inner">
        ...
        >
          ...
          <div className="gpv1-product-image">
            <Image
              src="/images/GALAXY-PRO-V4C/pic1.png"
              alt="Galaxy Pro V4C gelato machine"
              width={560}
              height={470}
...
function GpV4CSpecs() {
  const specs = [
    { label: "Dimensions", value: "1500mm \u00d7 800mm \u00d7 2400mm" },
    ...
    >
      <div className="gpv1-specs-inner">
        <motion.div className="gpv1-specs-image" variants={scaleIn}>
          <Image
            src="/images/GALAXY-PRO-V4C/pic3.png"
            alt="Galaxy Pro V4C dimensional drawing — 1500mm x 800mm x 2400mm"
            width={560}
            height={470}
            style={{ objectFit: "contain", width: "100%", height: "auto" }}
          />
    ...
    <section className="gpv1-cta">
      ...
      >
        <motion.h2 className="gpv1-cta-title" variants={fadeUp}>
          Interested in the Galaxy Pro V4C?
        </motion.h2>
...
/* ─── Page ─── */
export default function GalaxyProV4CPage() {
  return (
    <>
      <Navbar />
      <GpV4CTitle />
